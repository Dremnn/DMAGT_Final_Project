    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxSize(350, -1))
{
    ...
    wxButton* clearButton = new wxButton(this, wxID_ANY, _T("Xóa các đường đi")); // Nút mới
    ...
    clearButton->Bind(wxEVT_BUTTON, &SearchPanel::OnClearClicked, this); // Liên kết sự kiện click
}
